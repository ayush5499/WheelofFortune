# -*- coding: utf-8 -*-
"""
Created on Fri Jun 26 16:07:30 2020
...
class WOFComputerPlayer(WOFPlayer):
    ...
    def getPossibleLetters(self,guessed):
        ...
        for letr in LETTERS:
            if letr in guessed:
                pass
            elif letr in VOWELS and self.prizeMoney < VOWEL_COST:
                pass
            else:
                left.append(letr)
    ...
    def getMove(self,category, obscuredPhrase, guessed):
        ...
        left = self.getPossibleLetters(guessed)
        
        if len(left) == 0:
            return 'pass'
        
        if self.smartCoinFlip():
            x = [letter for letter in WOFComputerPlayer.SORTED_FREQUENCIES]
            x.reverse()
            for letr in x:
                if letr in left:
                    return letr
